...
/* ./.libs/lt-hello-world.c - temporary wrapper executable for .libs/hello-world
...
const char * TARGET_PROGRAM_NAME = "hello-world"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# hello-world - temporary wrapper script for .libs/hello-world\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The hello-world program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"hello-world:hello-world:${LINENO}: libtool wrapper (GNU libtool) 2.4.", f);
  fputs ("2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"hello-world:hello-world:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"hello-world:hello-world:${LINENO}: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);

...
/* ./.libs/lt-signal-test.c - temporary wrapper executable for .libs/signal-test
   Generated by libtool (GNU libtool) 2.4.2

   The signal-test program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "signal-test"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# signal-test - temporary wrapper script for .libs/signal-test\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The signal-test program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"signal-test:signal-test:${LINENO}: libtool wrapper (GNU libtool) 2.4.", f);
  fputs ("2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"signal-test:signal-test:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"signal-test:signal-test:${LINENO}: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);

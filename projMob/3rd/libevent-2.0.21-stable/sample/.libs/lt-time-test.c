...
/* ./.libs/lt-time-test.c - temporary wrapper executable for .libs/time-test
   Generated by libtool (GNU libtool) 2.4.2

   The time-test program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "time-test"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# time-test - temporary wrapper script for .libs/time-test\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The time-test program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"time-test:time-test:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"time-test:time-test:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"time-test:time-test:${LINENO}: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);

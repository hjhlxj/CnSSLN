...
/* ./.libs/lt-test-changelist.c - temporary wrapper executable for .libs/test-changelist
   Generated by libtool (GNU libtool) 2.4.2

   The test-changelist program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "test-changelist"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test-changelist - temporary wrapper script for .libs/test-changelist\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The test-changelist program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"test-changelist:test-changelist:${LINENO}: libtool wrapper (GNU libto", f);
  fputs ("ol) 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test-changelist:test-changelist:${LINENO}: newargv[$lt_dump_args_N]:", f);
  fputs (" $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test-changelist:test-changelist:${LINENO}: newargv[0]: $progdir/", f);
  fputs ("$program\" 1>&2\n", f);

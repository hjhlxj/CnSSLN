...
/* ./.libs/lt-bench_httpclient.c - temporary wrapper executable for .libs/bench_httpclient
   Generated by libtool (GNU libtool) 2.4.2

   The bench_httpclient program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/cygdrive/e/weiyun/tmp/project/mobileDev/projMob/3rd/libevent-2.0.21-stable/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/cygdrive/e/weiyun/tmp/project/mobileDev/projMob/3rd/libevent-2.0.21-stable/.libs:/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "bench_httpclient"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# bench_httpclient - temporary wrapper script for .libs/bench_httpclient\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The bench_httpclient program cannot be directly executed until all the libtoo", f);
  fputs ("l\n", f);
  ...
  fputs ("  notinst_deplibs=' ../libevent_core.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"bench_httpclient:bench_httpclient:${LINENO}: libtool wrapper (GNU lib", f);
  fputs ("tool) 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"bench_httpclient:bench_httpclient:${LINENO}: newargv[$lt_dump_args_N", f);
  fputs ("]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"bench_httpclient:bench_httpclient:${LINENO}: newargv[0]: $progdi", f);
  fputs ("r/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='bench_httpclient'\n", f);
  ...
  fputs ("    PATH=/cygdrive/e/weiyun/tmp/project/mobileDev/projMob/3rd/libevent-2.0.21-s", f);
  fputs ("table/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/e/weiyun/tmp/project/mobileDev/projMob/3rd/libevent-2.0.21-", f);
  fputs ("stable/.libs:$PATH\"\n", f);
  fputs ("\n", f);

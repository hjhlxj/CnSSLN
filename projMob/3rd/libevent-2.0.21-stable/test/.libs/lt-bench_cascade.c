...
/* ./.libs/lt-bench_cascade.c - temporary wrapper executable for .libs/bench_cascade
   Generated by libtool (GNU libtool) 2.4.2

   The bench_cascade program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "bench_cascade"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# bench_cascade - temporary wrapper script for .libs/bench_cascade\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The bench_cascade program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../libevent.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"bench_cascade:bench_cascade:${LINENO}: libtool wrapper (GNU libtool) ", f);
  fputs ("2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"bench_cascade:bench_cascade:${LINENO}: newargv[$lt_dump_args_N]: $lt", f);
  fputs ("_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"bench_cascade:bench_cascade:${LINENO}: newargv[0]: $progdir/$pro", f);
  fputs ("gram\" 1>&2\n", f);

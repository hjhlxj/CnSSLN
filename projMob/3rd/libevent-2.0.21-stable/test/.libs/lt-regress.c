...
/* ./.libs/lt-regress.c - temporary wrapper executable for .libs/regress
   Generated by libtool (GNU libtool) 2.4.2

   The regress program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "regress"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# regress - temporary wrapper script for .libs/regress\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The regress program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../libevent.la ../libevent_pthreads.la /cygdrive/e/weiyun/t", f);
  fputs ("mp/project/mobileDev/projMob/3rd/libevent-2.0.21-stable/libevent_core.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"regress:regress:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"regress:regress:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"regress:regress:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);

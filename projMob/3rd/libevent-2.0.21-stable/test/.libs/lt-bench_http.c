...
/* ./.libs/lt-bench_http.c - temporary wrapper executable for .libs/bench_http
   Generated by libtool (GNU libtool) 2.4.2

   The bench_http program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "bench_http"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# bench_http - temporary wrapper script for .libs/bench_http\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The bench_http program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"bench_http:bench_http:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\"", f);
  fputs (" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"bench_http:bench_http:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"bench_http:bench_http:${LINENO}: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);

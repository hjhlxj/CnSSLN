...
/* ./.libs/lt-test-time.c - temporary wrapper executable for .libs/test-time
   Generated by libtool (GNU libtool) 2.4.2

   The test-time program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "test-time"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test-time - temporary wrapper script for .libs/test-time\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The test-time program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"test-time:test-time:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test-time:test-time:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test-time:test-time:${LINENO}: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
